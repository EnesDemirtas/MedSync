...
func toDBMedicine(med medicinebus.Medicine) dbMedicine {
...
func toCoreMedicineSlice(dbMedicines []dbMedicine) []medicinebus.Medicine {
	meds := make([]medicinebus.Medicine, len(dbMedicines))
