...
func New(cfg Config) (*Auth, error) {
	...
	// user enabled check.
	var user *userbus.Core
	if cfg.DB != nil {
		user = userbus.NewCore(cfg.Log, nil, userdb.NewStore(cfg.Log, cfg.DB))
	}
...
// isUserEnabled hits the database and checks the user is not disabled. If no
// database connection was provided, this check is skipped.
